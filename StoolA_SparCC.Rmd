...
```{r cache=FALSE, results=FALSE, warning=FALSE, comment=FALSE, writing=FALSE}
T1_cluster<-cluster_louvain(T1_SparCC)
plot(T1_cluster, T1_SparCC, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T2_cluster<-cluster_louvain(T2_SparCC)
plot(T2_cluster, T2_SparCC, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T3_cluster<-cluster_louvain(T3_SparCC)
plot(T3_cluster, T3_SparCC, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
