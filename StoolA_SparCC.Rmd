...
hist(degree(T1_SparCC), freq = FALSE, main = "Before travel", ylab = "Density",
     col = "khaki")
lines(dx1, lwd = 2, col = "red")
rug(jitter(degree(T1_SparCC)))

hist(degree(T2_SparCC), freq = FALSE, main = "During travel", ylab = "Density",
     col = "khaki")
lines(dx2, lwd = 2, col = "blue")
rug(jitter(degree(T2_SparCC)))

hist(degree(T3_SparCC), freq = FALSE, main = "After travel", ylab = "Density",
     col = "khaki")
...
plot(dx1, lwd = 2, main = "Degree densities", xlab = "",
...
plot_multiplex3D(g.list, layer.layout=lay,
                 ...
                 show.aggregate=T)
```
Análisis de clusters por método Louvain
```{r cache=FALSE, results=FALSE, warning=FALSE, comment=FALSE, writing=FALSE}
...
plot(T3_cluster, T3_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
Análisis de clusters por método optimal
```{r eval=FALSE}
T1_SparCCA<-delete.vertices(T1_SparCC, which(degree(T1_SparCC) == 0))
T1_cluster<-cluster_optimal(T1_SparCCA)
plot(T1_cluster, T1_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T2_SparCCA<-delete.vertices(T2_SparCC, which(degree(T2_SparCC) == 0))
T2_cluster<-cluster_optimal(T2_SparCCA)
plot(T2_cluster, T2_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T3_SparCCA<-delete.vertices(T3_SparCC, which(degree(T3_SparCC) == 0))
T3_cluster<-cluster_optimal(T3_SparCCA)
plot(T3_cluster, T3_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
Análisis de clusters por método fast-greedy
```{r}
T1_SparCCA<-delete.vertices(T1_SparCC, which(degree(T1_SparCC) == 0))
T1_cluster<-cluster_fast_greedy(T1_SparCCA)
plot(T1_cluster, T1_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T2_SparCCA<-delete.vertices(T2_SparCC, which(degree(T2_SparCC) == 0))
T2_cluster<-cluster_fast_greedy(T2_SparCCA)
plot(T2_cluster, T2_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
T3_SparCCA<-delete.vertices(T3_SparCC, which(degree(T3_SparCC) == 0))
T3_cluster<-cluster_fast_greedy(T3_SparCCA)
plot(T3_cluster, T3_SparCCA, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
