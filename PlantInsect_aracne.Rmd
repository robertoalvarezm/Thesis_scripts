...
```{r}
insect_cluster<-cluster_louvain(insect_aracne)
plot(insect_cluster, insect_aracne, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
plant_cluster<-cluster_louvain(plant_aracne)
plot(plant_cluster, plant_aracne, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
