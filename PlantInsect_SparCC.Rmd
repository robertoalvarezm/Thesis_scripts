...
```{r}
insect_cluster<-cluster_louvain(insect_sparCC)
plot(insect_cluster, insect_sparCC, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
plant_cluster<-cluster_louvain(plant_sparCC)
plot(plant_cluster, plant_sparCC, vertex.label.color="black",
     vertex.label.cex=.5,layout=layout_with_kk, vertex.size = 5)
```
